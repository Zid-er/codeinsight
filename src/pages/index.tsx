  ...
  return (
    <div className="flex flex-col py-12 gap-2 md:px-32">
      <div className="flex flex-row gap-1 items-center w-full">
        ...
        {/* <button className="px-4 py-2 dark:bg-primary rounded flex flex-row gap-4 justify-center items-center bg-slate-50"> */}
          {/* <p className="bg-transparent">Tag</p>
          <Image src={dar} alt="dbl d arrow" width="10" height="10" className="bg-transparent" /> */}
          {/* <select className="outline-none rounded border-none bg-transparent">
            <option>Tag</option>
            <option>JS</option>
            <option>C#</option>
            <option>C++</option>
